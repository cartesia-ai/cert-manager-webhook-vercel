...
helm install cert-manager-webhook-vercel \
  ...
  https://github.com/rhythmbhiwani/cert-manager-webhook-vercel/releases/download/cert-manager-webhook-vercel-v1.1.2/cert-manager-webhook-vercel-v1.1.2.tgz
```
